...
## Project Structure
    ...
    ├── plain_resonance_dev_60714  # Django project configurations
...
1. Clone this repo and `cd plain_resonance_dev_60714`
...
2. Clone this repo and `cd plain_resonance_dev_60714`
